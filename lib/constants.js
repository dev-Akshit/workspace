...
const shortTermSessionExpireTime_Seconds = 900;
...
const emailContent = {
    ...
    [emailType.checkOtp]: {
        'subject': 'Verify New Session',
        'content': renderTemplateFile('checkOtp'),
    }
}

const queryParamsMessageType = {
    success: 1,
    error: 2,
}
...
module.exports = {
    ...
    shortTermSessionExpireTime_Seconds,
    queryParamsMessageType,
}